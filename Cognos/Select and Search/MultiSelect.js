  ...
  class MyDataLoggingControl {
    ...
    draw(oControlHost) {
      ...
      if (config["Container Width"]) {
        this._container.style.width = config["Container Width"] || "250px";
      }
      ...
      if (config["Dropdown Width"]) {
        dropdownHeader.style.width = config["Dropdown Width"] || "250px";
      }
      if (config["Dropdown Height"]) {
        dropdownHeader.style.height = config["Dropdown Height"] || "36px";
      }
      ...
      if (config["List Container Width"]) {
        dropdownListContainer.style.width = config["List Container Width"] || "250px";
        dropdownListContainer.style.left = "auto";
        dropdownListContainer.style.right = "auto";
      }
      if (config["List Container Height"]) {
        dropdownListContainer.style.height = config["List Container Height"] || '400px';
