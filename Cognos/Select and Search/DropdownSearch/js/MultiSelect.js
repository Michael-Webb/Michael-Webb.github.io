                ...
                <div class="group" id="${groupId}">
                  <div class="group-header" id="${groupHeaderId}">
                    ...
                    ${
                      ...
                      <button class="btn secondary group-deselect" aria-label="Clear all selections in ${group.display}" title="Clear all selections in ${group.display}" id="${groupDeselectId}">Clear</button>
                    </div>`
                        : ""
                    }
                  </div>
