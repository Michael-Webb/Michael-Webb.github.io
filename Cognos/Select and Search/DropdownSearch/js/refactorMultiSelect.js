define(() => {
  ...
  class CustomControl {
    ...
    applyEventListeners() {
      ...
      this.iconSvg = this.searchIcon.querySelector("svg");

      // Define the SVG paths
      const magnifyingGlassSVG = `<svg xmlns="http://www.w3.org/2000/svg" id="iconSvg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#808080" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>`;
      const clearSVG = `<svg xmlns="http://www.w3.org/2000/svg" id="iconSvg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#808080" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>`;
