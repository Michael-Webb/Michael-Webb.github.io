...
class DocumentsOnline {
  ...
  /**
   * Encodes the given value using a Base64 encoding algorithm.
   *
   * @param {string} vValue - The value to encode.
...
// Expose the DocumentsOnline class globally so that Cognos can instantiate it.
window.DocumentsOnline = DocumentsOnline;
